...
<nav id="navbar" class="navbar nav-menu">
            <ul>
                <li><a href="#hero" class="nav-link scrollto"><i class="iconify" data-icon="simple-icons:homeassistant" data-width="35" data-height="35">></i> <span>Home</span></a></li>
                <li><a href="#about" class="nav-link scrollto"><i class="iconify" data-icon="carbon:user-profile" data-width="35" data-height="35"></i> <span>About</span></a></li>
                <li><a href="#resume" class="nav-link scrollto"><i class="iconify" data-icon="carbon:document-attachment" data-width="35" data-height="35"></i> <span>Resume</span></a></li>
                <li><a href="#contact" class="nav-link scrollto"><i  class="iconify" data-icon="ep:message-box" data-width="35" data-height="35"></i> <span>Contact</span></a></li>
